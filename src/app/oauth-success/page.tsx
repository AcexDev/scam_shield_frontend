...
function OAuthHandler() {
  ...
  return (
    <div className="fixed inset-0 dark:bg-[#0A0E1A] bg-[#EEF2FF] flex items-center justify-center p-4">
      ...
      >
        <Shield size={72} pulse={status === 'loading'} scanning={status === 'loading'} />
        ...
        {status === 'success' && (
          <>
            ...
            <div>
              <p className="text-base font-semibold text-emerald-400" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
        ...
        {status === 'error' && (
          <>
            ...
            <div>
              <p className="text-base font-semibold text-red-400" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Sign-in failed
              </p>
